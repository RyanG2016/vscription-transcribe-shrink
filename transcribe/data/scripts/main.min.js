...
function view(b){$.post("data/parts/backend_request.php",{reqcode:17,args:JSON.stringify({file_id:b})}).done(function(b){window.open("./view.php?down="+b.toString(),"_blank").focus();jobsDTRef.ajax.reload()})}function htmlEncodeStr(b){return b.replace(/&/g,"&amp;").replace(/>/g,"&gt;").replace(/</g,"&lt;").replace(/"/g,"&quot;").replace(/'/g,"&lsquo;")};

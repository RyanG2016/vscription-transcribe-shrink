...
$(this).parent().parent().attr("id");download(a)});$(".view-icon").click(function(){var a=$(this).parent().parent().attr("id");view(a)});$(".cTooltip").hasClass("tooltipstered")||$(".cTooltip").tooltipster({animation:"grow",theme:"tooltipster-punk",arrow:!0});$("#tjd").html("Total Jobs Length: "+(new Date(1E3*totalDur)).toISOString().substr(11,8))})});

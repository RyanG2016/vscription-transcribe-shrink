...
function(){jobPickerWindow=window.open("job_picker.php","modalPicker","toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=1000,height=500")});$("#switchBackBtn").click(function(){postToParent()});$("#discardBtn").click(function(){t()});$("#saveBtn").click(function(){h(!0)});$("#suspendBtn").click(function(){h(!1)});$.post(backend_url,{reqcode:204}).done(function(a){a?"0"===a?switchUI(!1):loadID(a):switchUI(!1)})});

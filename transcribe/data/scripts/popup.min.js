...
function(){jobPickerWindow=window.open("job_picker.php","modalPicker","toolbar=yes,scrollbars=yes,resizable=yes,top=500,left=500,width=1000,height=500")});$("#switchBackBtn").click(function(){postToParent()});$("#discardBtn").click(function(){u()});$("#saveBtn").click(function(){k(!0)});$("#suspendBtn").click(function(){k(!1)});$.post(backend_url,{reqcode:204}).done(function(a){console.log("session saved id is "+a);a?"0"===a?switchUI(!1):loadID(a):switchUI(!1)})});

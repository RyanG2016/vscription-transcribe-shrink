...
"none"):(chooseJobModal.style.display="block",loading.style.display="none")}})}loading=document.getElementById("overlay");loading.style.display="block";currentRole=$("#currentRole");currentAccName=$("#currentAccountName");updateRoleModalBtn=$("#updateRoleBtn");closeModalBtn=$("#closeModalBtn");changeRoleBtn=$("#changeRoleBtn");modalHeaderTitle=$("#modalHeaderTitle");setDefaultRoleBtn=$("#setDefaultRoleBtn");accessId=$("#accessId");accountBox=$("#accountBox");roleBox=$("#roleBox");chooseJobModal=document.getElementById("modal");
closeModalBtn.on("click",function(a){chooseJobModal.style.display="none"});changeRoleBtn.on("click",function(a){setModalUI(!1);chooseJobModal.style.display="block"});setDefaultRoleBtn.on("click",function(a){setModalUI(!0);chooseJobModal.style.display="block"});updateRoleModalBtn.on("click",function(a){updateRoleModalBtn.attr("disabled","disabled");a=new FormData;a.append("acc_id",accountBox.selectpicker("val"));a.append("acc_role",roleBox.selectpicker("val"));$.ajax({type:"POST",url:setDefaultModal?
SET_DEFAULT_ACCESS_URL:ACCESS_URL,processData:!1,data:convertToSearchParam(a),success:function(a){chooseJobModal.style.display="none";location.reload()},error:function(a){$.confirm({title:"Error",content:a.responseJSON.msg,buttons:{confirm:{btnClass:"btn-red",action:function(){updateRoleModalBtn.removeAttr("disabled");return!0}}}})}})});$.ajax({url:ACCESS_URL,method:"GET",success:function(a){accessesGlobal=a;var b=document.getElementById("accountBox");a=$jscomp.makeIterator(a);for(var e=a.next();!e.done;e=
a.next())e=e.value,-1==accountsArray.indexOf(e.acc_id)&&(accountsArray.push(e.acc_id),b.innerHTML+="<option value='"+e.acc_id+"'>"+e.acc_id+" - "+e.acc_name+"</option>");accountBox.selectpicker({liveSearch:!0,liveSearchPlaceholder:"Choose Account"});c(accountBox.selectpicker("val"));accountBox.on("changed.bs.select",function(a,b,d,e){c(accountBox.selectpicker("val"))})}})});function removeLoadingSpinner(){$(".spinner").remove()}

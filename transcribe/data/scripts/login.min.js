...
function showResetPasswordForm(){srcIsLogin=!1;forgotPwd.slideUp();pwdDiv.slideUp();loginBtn.html("Send Reset Link");loginBtn.removeAttr("disabled");formTitle.html("Reset Password");remember.slideUp()}
...
function login(){loginBtn.html("Please wait..");loginBtn.attr("disabled","");var a=$('.validate-input .input100[name="email"]').val(),b=$('input[name="password"]').val(),c={};1===($('input[name="remember"]').is(":checked")?1:0)&&(c="rememberme");$.ajax({type:"POST",url:"api/v1/login/",data:c,async:!1,beforeSend:function(d){d.setRequestHeader("Authorization","Basic "+btoa(a+":"+b))},success:function(){location.href="index.php"},error:function(b){void 0!==b.responseJSON.code?5===b.responseJSON.code?
$.confirm({title:"Error",type:"red",content:b.responseJSON.msg,buttons:{confirm:{btnClass:"btn-red",text:"Ok"},resend:{btnClass:"btn-green",text:"Resend Email",action:function(){loginBtn.html("Please wait..");loginBtn.attr("disabled","");$.post("data/parts/backend_request.php",{reqcode:50,args:JSON.stringify({email:a})}).done(function(a){$.confirm({title:"Success",type:"green",content:"Verification Email sent.",buttons:{confirm:{text:"OK",btnClass:"btn-green",action:function(){showLoginFields()}}}})})}}}}):
404===b.responseJSON.code?$.confirm({title:"Hmm..",type:"red",content:b.responseJSON.msg,buttons:{confirm:{btnClass:"btn-red",text:"Ok"}}}):$.confirm({title:"Error",type:"red",content:b.responseJSON.msg,buttons:{confirm:{btnClass:"btn-red",text:"Ok"}}}):$.confirm({title:"Error",type:"red",content:b.responseJSON.msg,buttons:{confirm:{btnClass:"btn-red",text:"Ok"}}});showLoginFields()}})}
function resetpw(){var a={email:email.val()};$.post("data/parts/backend_request.php",{reqcode:40,args:JSON.stringify(a)}).done(function(b){1==b?$.post("data/parts/backend_request.php",{reqcode:30,args:JSON.stringify(a)}).done(function(){$.confirm({title:"Success",type:"green",content:"Reset password email sent.",buttons:{confirm:{text:"OK",btnClass:"btn-green",action:function(){showLoginFields()}}}})}):$.confirm({title:"Hmm..",type:"red",content:"We couldn't find your account.",buttons:{confirm:{text:"try again",

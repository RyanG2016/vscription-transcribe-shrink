...
function resetpw(){var a={email:email.val()};$.post("data/parts/backend_request.php",{reqcode:40,args:JSON.stringify(a)}).done(function(a){1==a?(a=new FormData,a.append("email",vemail),$.ajax({type:"POST",url:"/api/v1/login/reset/",data:a,processData:!1,contentType:!1,success:function(a){$.confirm({title:"Success",type:"green",content:a.msg,buttons:{confirm:{text:"OK",btnClass:"btn-green",action:function(){showLoginFields()}}}})},error:function(a){$.confirm({title:"oops..",type:"red",content:a.responseJSON.msg,

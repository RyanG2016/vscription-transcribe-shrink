...
var loadingOverlay,loadingText,stateRequest,stateGroup,signupBtn,form,pwd,countryBox,stateBox,countriesURL="../api/v1/countries/",stateURL="../api/v1/cities/",firstLaunch=!0;
$(document).ready(function(){function b(){var a=pwd.val();if(/(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*()_+\-=\[\]{};':"\\|,. <>\/?]).{8,}/gm.test(a))return console.log("password match"),pwd.removeClass("is-invalid"),form.classList.add("was-validated"),!0;form.classList.remove("was-validated");pwd.addClass("is-invalid");console.log("password doesn't match");return!1}signupBtn=$("#signupBtn");loadingText=$("#loadingText");stateGroup=$("#stateGroup");countryBox=$("#countryBox");stateBox=$("#stateBox");
loadingOverlay=$("#overlay");pwd=$("#inputPassword");form=document.getElementById("signupForm");pwd.popover({html:!0,content:"<ul>\n    <li><b>minimum length is 8 characters.</b></li>\n    <li>at least 1 uppercase.</li>\n    <li>at least 1 lowercase.</li>\n    <li>at least 1 number.</li>\n    <li>at least 1 special character.</li>\n</ul>"});pwd.keyup(function(){firstLaunch?firstLaunch=!1:b()});form.addEventListener("submit",function(a){if(!0===(b()&&form.checkValidity())){a=$("#countryBox option:selected").text();
var c=new FormData,d=$("#signupForm").serializeArray();$.each(d,function(a,b){c.append(b.name,b.value)});c.append("country",a);$.ajax({type:"POST",url:api_insert_url,data:c,processData:!1,contentType:!1,success:function(a){},error:function(a){}})}},!1);$("body").niceScroll({hwacceleration:!0,smoothscroll:!0,cursorcolor:"#f5862c",cursorborder:0,scrollspeed:10,mousescrollstep:20,cursoropacitymax:.7});countryBox.on("changed.bs.select",function(a,b,d,e){a=countryBox.selectpicker("val");"203"===a||"204"===
a?(loadingOverlay[0].style.display="block",stateGroup[0].style.display="block",loadState(countryBox.selectpicker("val"))):stateGroup[0].style.display="none"});loadingText.html("Loading countries..");loadCountries()});

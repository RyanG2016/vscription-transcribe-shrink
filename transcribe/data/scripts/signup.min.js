...
!1:b()});confirmPwd.keyup(function(){firstLaunch?firstLaunch=!1:b()});form.addEventListener("submit",function(a){a.preventDefault();a.stopPropagation();if(!0===(b()&&form.checkValidity())){a=$("#countryBox option:selected").text();var c=new FormData,d=$("#signupForm").serializeArray();$.each(d,function(a,b){c.append(b.name,b.value)});c.append("country",a);ref&&c.append("ref",ref);$.ajax({type:"POST",url:signupURL,data:c,processData:!1,contentType:!1,success:function(a){$.confirm({title:"Success",
type:"green",content:a.msg,buttons:{confirm:{text:"OK",btnClass:"btn-green",action:function(){location.href="index.php"}}}})},error:function(a){null!=a.responseJSON.code&&301==a.responseJSON.code?$.confirm({title:"oops..",type:"red",content:a.responseJSON.msg,buttons:{confirm:{text:"Yes",btnClass:"btn-green",action:function(){location.href="index.php"}},cancel:{text:"No",btnClass:"btn-red"}}}):$.confirm({title:"oops..",type:"red",content:a.responseJSON.msg,buttons:{confirm:{text:"OK",btnClass:"btn-green"}}})}})}},
!1);$("body").niceScroll({hwacceleration:!0,smoothscroll:!0,cursorcolor:"#f5862c",cursorborder:0,scrollspeed:10,mousescrollstep:20,cursoropacitymax:.7});countryBox.on("changed.bs.select",function(a,b,d,e){a=countryBox.selectpicker("val");"203"===a||"204"===a?(loadingOverlay[0].style.display="block",stateGroup[0].style.display="block",loadState(countryBox.selectpicker("val"))):stateGroup[0].style.display="none"});loadingText.html("Loading countries..");loadCountries()});

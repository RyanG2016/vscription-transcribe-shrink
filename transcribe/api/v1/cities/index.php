...
use Src\Controller\CityController;
...
// all of our endpoints start with /api/v1/cities
...
// the city id is, of course, optional and must be a number:
$cityId = null;
if (isset($uri[4])) {
    $cityId = (int)$uri[4];
}
...
$controller = new CityController($dbConnection, $requestMethod, $cityId);

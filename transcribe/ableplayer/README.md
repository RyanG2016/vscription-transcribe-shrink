***THIS IS A FORK. WE ARE MAKING CHANGES TO USE THIS WITH OUR
***VSCRIPTION TRANSCRIBE PRODUCT - RG
***CHANGES WILL BE MARKED HERE

vScription Customizations
=========================

- Added the ability to use Meta Key as a modifier
- Using different hotkeys as per requirements for foot controls

...
*/
	...
	AblePlayer.prototype.injectPrefsForm = function (form) {
				...
				if (form === 'captions') {
					...
					if (form === 'keyboard') {
						...
						$thisField.change(function() {
							...
							else if (changedPref === 'prefMetaKey') {
								changedSpan = '.able-modkey-meta';
								changedText = thisObj.tt.prefMetaKey + ' + ';
							}
							if ($(this).is(':checked')) {
		...
		if (form === 'captions') {
			...
			for (i=0; i<keys.length; i++) {
				...
				// meta
				kbListText += '<span class="able-modkey-meta">';
				if (this.prefMetaKey === 1) {
					kbListText += this.tt.prefMetaKey + ' + ';
				}				
				kbListText += '</span>';
	...
	AblePlayer.prototype.usingModifierKeys = function(e) {
		...
		if ((this.prefMetaKey === 1) && !e.metaKey) {
			return false;
		}		
		return true;
	};

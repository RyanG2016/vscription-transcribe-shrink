...
//				svg[0] = '0 0 16 20';
				...
				svg[0] = '-40 -130 500 600';
				svg[1] = 'M424.4 233.3L72.4 441.4C43.8 458.3 0 441.9 0 400.1V-16C0 -53.5 40.7 -76.1 72.4 -57.3L424.4 150.7C455.8 169.2 455.9 214.8 424.4 233.3z';
...
//				svg[1] = 'M0 18.393v-16.429q0-0.29 0.184-0.402t0.441 0.033l14.821 8.237q0.257 0.145 0.257 0.346t-0.257 0.346l-14.821 8.237q-0.257 0.145-0.441 0.033t-0.184-0.402z';
			...
			case 'pause':
//				svg[0] = '0 0 20 20';
				svg[0] = '-28 -140 500 600';
				svg[1] = ' M144 -31H48C21.5 -31 0 -9.5 0 17V369C0 395.5 21.5 417 48 417H144C170.5 417 192 395.5 192 369V17C192 -9.5 170.5 -31 144 -31zM448 17V369C448 395.5 426.5 417 400 417H304C277.5 417 256 395.5 256 369V17C256 -9.5 277.5 -31 304 -31H400C426.5 -31 448 -9.5 448 17z';
...
*/
	...
	AblePlayer.prototype.injectPrefsForm = function (form) {
		...
		if (form == 'captions') {
			...
			$prefsDiv.append("These hotkeys are only needed if you are not using a foot control and will not work when the application is in the background.");
			$prefsDiv.append($prefsIntro);
...
(function ($) {
	...
	AblePlayer.prototype.seekToAndDelete = function (newTime) {
//		alert('seek base');
		// define variables to be used for analytics
		// e.g., to measure the extent to which users seek back and forward
		this.seekFromTime = this.media.currentTime;
						...
						if (!thisObj.seekBar.tracking && !thisObj.stoppingYouTube) {
							if (currentState === 'paused' || currentState === 'stopped' || currentState === 'ended') {
								...
								if (thisObj.iconType === 'font') {
									...
									thisObj.$playpauseButton.find('svg')[0].setAttribute('viewBox',newSvgData[0]);
	...
	AblePlayer.prototype.addHtml5MediaListeners = function () {
        ...
        thisObj.duration = thisObj.media.duration;
			...
			.on('canplaythrough',function() {
				...
				if (thisObj.seekTrigger == 'chapter' || thisObj.seekTrigger == 'transcript') {
...
(function ($) {
	...
	AblePlayer.prototype.injectVtsTable = function(action,lang) {
		...
		for (i=0; i < headers.length; i++) {
			$th = $('<th><meta http-equiv="Content-Type" content="text/html; charset=utf-8">', {
				'scope': 'col'
			}).text(headers[i]);

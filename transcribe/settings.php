                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="email" name="email"
                                                placeholder="" data-parsley-type="email"
                                            ...
                                            <div class="row w-100 no-gutters">
                                                <div class="col-auto">
                                                    ...
                                                    &emsp;<button id="newsletter" type="button"
                                                        ...
                                                        data-toggle="button"
                                                        aria-pressed="<?php echo (isset($_SESSION['userData']['newsletter']) && $_SESSION['userData']['newsletter'] == 1) ? 'true' : 'false' ?>">
                                                ...
                                                <div class="col text-right">
                                                    ...
                                                    &emsp;<button id="emailTranscript" type="button"
                                                        ...
                                                        data-toggle="button"
                                                        aria-pressed="<?php echo (isset($_SESSION['userData']['email_notification']) && $_SESSION['userData']['email_notification'] == 1) ? 'true' : 'false' ?>">
                                                        <span class="vspt-check-toggle-icon"></span>
                                                    </button>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="address" name="address"
                                                placeholder="" data-parsley-pattern="/^[a-z0-9_ .]{5,100}$/i"
                                                aria-describedby="inputGroupPrepend"
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="orgName"
                                                ...
                                                data-parsley-error-message="<?php echo CUSTOM_FIELD_ERRORS::ORG ?>"
                                                placeholder="" aria-describedby="inputGroupPrepend"
                                                value="<?php echo $_SESSION['acc_name'] ?>" required>
                                        </div>
                                        ...
                                        <div class="row no-gutters w-100 ret">
                                            <div class="col">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Organization Retention
                                                            Time</span>
                                                    </div>
                                                    <input type="number" class="form-control" id="orgRetTime"
                                                        placeholder="" name="retention_time"
                                                        aria-describedby="inputGroupPrepend"
                                                        value="<?php echo $_SESSION['acc_retention_time'] ?>"
                                                        data-parsley-error-message="<?php echo CUSTOM_FIELD_ERRORS::RETENTION_TIME ?>"
                                                        max="180" min="1" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    <div class="input-group-prepend">
                                                        <span class="input-group-text">Activity Log Retention
                                                            Time</span>
                                                    </div>

                                                    <input type="number" class="form-control" id="orgLogTime"
                                                        placeholder="" max="180" min="1" name="act_log_ret_time"
                                                        aria-describedby="inputGroupPrepend"
                                                        data-parsley-error-message="<?php echo CUSTOM_FIELD_ERRORS::LOG_RETENTION_TIME ?>"
                                            ...
                                            <div class="row w-100 no-gutters">
                                                        ...
                                                        <div class="col text-right">
                                                            <div class="mdc-switch mdc-switch--disabled ml-auto mt-auto mb-auto"
                                                                ...
                                                                <div class="mdc-switch__thumb-underlay">
                                                                    ...
                                                                    <input type="checkbox" id="jlSwitchCheckbox"
                                                ...
                                                <div class="col">
                                                    <div class="input-group input-group-jl">
                                                        <div class="input-group-prepend">
                                                            <span class="input-group-text">Job List Refresh
                                                                Interval</span>
                                                        </div>

                                                        <input type="number" class="form-control"
                                                            id="orgJobListRefreshInterval" placeholder="" max="300"
                                                            min="30" name="auto_list_ref_interval"
                                                            aria-describedby="inputGroupPrepend"
                                        ...
                                        <div class="input-group">
                                            <div class="row w-100 no-gutters">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col text-right">
                                                            <div class="mdc-switch mdc-switch--disabled ml-auto mt-auto mb-auto"
                                                                ...
                                                                <div class="mdc-switch__thumb-underlay">
                                                                    <div class="mdc-switch__thumb"></div>
                                                                    <input type="checkbox" id="srSwitchCheckbox"
                                                                        class="mdc-switch__native-control" role="switch"
                                                                        aria-checked="false" disabled>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col sr-balance-div"><span
                                                    ...
                                                    <button class="btn btn-primary add-mins-btn" type="button"
                                                        onclick="window.open('/packages.php', '_blank')">
                                                        <i class="fas fa-plus-circle"></i> ADD MINS
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="btn btn-primary vspt-small-btn" type="button"
                                            onclick="window.open('/manage_users.php', '_blank')">
                                    ...
                                    <div class="col">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="ownOrgName"
                                                ...
                                                data-parsley-error-message="<?php echo CUSTOM_FIELD_ERRORS::ORG ?>"
                                                placeholder="" aria-describedby="inputGroupPrepend"
                                                value="<?php echo $_SESSION['adminAccountName'] ?>" required>
                                        </div>
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="ownOrgRetTime"
                                                        placeholder="" name="retention_time"
                                                        aria-describedby="inputGroupPrepend"
                                                        value="<?php echo $_SESSION['adminAccRetTime'] ?>" max="180"
                                                        min="1"
                                                        data-parsley-error-message="<?php echo CUSTOM_FIELD_ERRORS::RETENTION_TIME ?>"
                                                        required>
                                                </div>
                                            ...
                                            <div class="col">
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control" id="ownOrgLogTime"
                                                        placeholder="" max="180"
                                                        data-parsley-error-message="<?php echo CUSTOM_FIELD_ERRORS::LOG_RETENTION_TIME ?>"
                                                        min="1" name="act_log_ret_time"
                                                        aria-describedby="inputGroupPrepend"
                                                        value="<?php echo $_SESSION['adminAccLogRetTime'] ?>" required>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row w-100 no-gutters">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col text-right">
                                                            <div class="mdc-switch mdc-switch--disabled ml-auto mt-auto mb-auto"
                                                                ...
                                                                <div class="mdc-switch__thumb-underlay">
                                                                    <div class="mdc-switch__thumb"></div>
                                                                    <input type="checkbox" id="jlOwnSwitchCheckbox"
                                                                        class="mdc-switch__native-control" role="switch"
                                                                        aria-checked="false" disabled>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col">
                                                    <div class="input-group input-group-jl">
                                                        ...
                                                        <input type="number" class="form-control"
                                                            id="ownOrgJobListRefreshInterval" placeholder="" max="300"
                                                            min="30" name="auto_list_ref_interval"
                                                            aria-describedby="inputGroupPrepend"
                                                            data-parsley-error-message="<?php echo CUSTOM_FIELD_ERRORS::LIST_REFRESH_INTERVAL ?>"
                                        ...
                                        <div class="input-group">
                                            <div class="row w-100 no-gutters">
                                                    ...
                                                    <div class="form-row">
                                                        ...
                                                        <div class="col text-right">
                                                            <div class="mdc-switch mdc-switch--disabled ml-auto mt-auto mb-auto"
                                                                ...
                                                                <div class="mdc-switch__thumb-underlay">
                                                                    <div class="mdc-switch__thumb"></div>
                                                                    <input type="checkbox" id="ownSrSwitchCheckbox"
                                                                        class="mdc-switch__native-control" role="switch"
                                                                        aria-checked="false" disabled>
                                                                </div>
                                                            </div>
                                                ...
                                                <div class="col sr-balance-div"><span
                                                    ...
                                                    <button class="btn btn-primary add-mins-btn" type="button"
                                                        onclick="window.open('/packages.php?self', '_blank')">
                                                        <i class="fas fa-plus-circle"></i> ADD MINS
                                                    </button>
                                                </div>
                                            </div>
...
-->
                        ...
                        <div class="position-fixed bottom-0 toast-container right-0 p-3"
                            style="z-index: 50000; right: 0; bottom: 0;">
                            <div id="sttToast" class="toast hide" role="alert" aria-live="assertive" aria-atomic="true"
                                data-delay="3000">
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="text" class="form-control" id="accNameTxt" aria-describedby="acc_name_help"
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" id="createAdminAccBtn"><i class="fas fa-plus"></i>
                        &nbsp;Create</button>
                </div>
            </div>
        </div>

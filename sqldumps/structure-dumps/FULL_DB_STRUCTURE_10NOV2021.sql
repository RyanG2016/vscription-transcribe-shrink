...
CREATE TABLE IF NOT EXISTS `accounts` (
  ...
  `bill_rate2_TAT` int(11) NOT NULL COMMENT 'in hours',
  ...
  `bill_rate3_TAT` int(11) NOT NULL COMMENT 'in hours',
  ...
  `bill_rate4_TAT` int(11) NOT NULL COMMENT 'in hours',
  ...
  `bill_rate5_TAT` int(11) NOT NULL COMMENT 'in hours',
  `bill_rate5_desc` varchar(255) DEFAULT NULL,
  `bill_rate5_min_pay` decimal(10,2) DEFAULT NULL,
  `lifetime_minutes` int(11) DEFAULT NULL,
  `work_types` mediumtext DEFAULT 'History and Physical,Correspondence,Follow Up,Consult,Letter,Other',
...
) ENGINE=InnoDB AUTO_INCREMENT=3794 DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE IF NOT EXISTS `files` (
  ...
  `audio_deleted_date` timestamp NULL DEFAULT NULL,
  `audio_file_deleted_date` timestamp NULL DEFAULT NULL,

...
//    private $requestParameter;
    ...
    public function __construct(private $db, private $requestMethod, private $requestParameter, private $rawURI)
    {
        $this->db = $db;
        ...
        $this->adminGateway = new adminGateway($db);
    }
    ...
    public function processRequest()
    {
        switch ($this->requestMethod) {
            case 'GET':
                ...
                if ($this->requestParameter === 'statistics') {
...
//                break;
//            case 'DELETE':
//                $response = $this->deleteaccess($this->requestParameter);
//                break;
            default:
                $response = $this->notFoundResponse();
                break;
...
//                    $response = $this->getaccess($this->requestParameter);
//                } else {
...
//                }
            ...
            */
            case 'DELETE':
                $response = $this->revokeAccess($this->requestParameter);
                break;
            default:
                $response = $this->notFoundResponse();
                break;

...
break;case "ff":AblePlayerInstances[0].handleFastForward();break;default:a.substring(0,7)===versionCheck?p(a.substring(7),q):a.substring(0,8)===welcomeName&&d(connected+"<i>"+a.substr(8)+"</i>",!0)}}function h(a){""!==AblePlayerInstances[0].media.src&&(a?AblePlayerInstances[0].playMedia():AblePlayerInstances[0].pauseMedia())}function k(a){var c=function(a){a=JSON.parse(a);var c=Math.floor(AblePlayerInstances[0].seekBar.position).toString();b.append("reqcode",205);b.append("file_id",currentFileID);
b.append("jobID",a.job_id);b.append("jobElapsedTimeSecs",c);b.append("jobAuthorName",a.file_author);b.append("jobFileName",a.origFilename);b.append("tempFilename",a.tempFilename);$fmtOrigDateDic=moment(a.file_date_dict).format("yyyy-MM-D");b.append("jobDateDic",$fmtOrigDateDic);b.append("jobStatus",e);fetch(backend_url,{method:"POST",body:b}).then(function(a){a.text().then(function(b){console.log(b);console.log(a);a.ok?(b={mailtype:10,usertype:2},3===e&&$.post("data/parts/backend_request.php",{reqcode:80,
args:JSON.stringify(b)}).done(function(a){}),f(),2===e?(loadingTitle.text("Done"),loadingSub.text("Job "+d+" suspended")):3===e?(loadingTitle.text("Done"),loadingSub.text("Job "+d+" marked as complete")):(loadingTitle.text("Done"),loadingSub.text("Job "+d+" updated successfully")),loadingConfirmBtn.css("display","")):(alert("Error Saving Job. Please contact support - ${data}\n We will attempt to save the text contents to your clipboard if there is any"),f(),g.style.display="none")})})},b=new FormData,
d=$(".jobNo").html().trim(),e=5;a||(e=2);loadingSub.text("Saving "+d+" data");loadingTitle.text("Please wait..");loadingConfirmBtn.css("display","none");g.style.display="block";$.post("data/parts/backend_request.php",{reqcode:11,args:JSON.stringify({file_id:currentFileID})}).done(function(a){c(a)})}function r(){var a=2;0===currentFileData.job_status&&(a=0);$.post("data/parts/backend_request.php",{reqcode:16,args:JSON.stringify({file_id:currentFileID,new_status:a})}).done(function(a){});f()}function f(){$(".title-default-text").css("display",

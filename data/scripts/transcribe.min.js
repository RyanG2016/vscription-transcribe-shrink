...
function completePlayer(){var a=$("#loadBtn"),b=$("#completeBtn"),c=AblePlayerInstances[0].media.src.split("/").pop();clearTempAudio(c);AblePlayerInstances[0].seekTo(0);AblePlayerInstances[0].media.pause();setTimeout(function(){AblePlayerInstances[0].media.removeAttribute("src");AblePlayerInstances[0].media.load()},300);a.removeClass("noHover");$("#loadBtn").html('<i class="fas fa-cloud-upload-alt"></i>&nbsp;Load');a.find("i").show();b.addClass("noHover");b.addClass("button");b.removeClass("button-green")}
